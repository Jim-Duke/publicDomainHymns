...
SheetMusicLyricsMinimumDistance = #2.8
...
FirstPage = #(if hark_I_hear_the_harps_eternal_number_rhs 1 2)
...
\header {
  ...
  lhs = #(if hark_I_hear_the_harps_eternal_number_rhs LeaderHints christ_the_lord_is_risen_today_mendelssohn_number)
  rhs = #(if hark_I_hear_the_harps_eternal_number_rhs christ_the_lord_is_risen_today_mendelssohn_number LeaderHints)
  meter = "8.7.8.7"
  poet = "F. R. Warren"
  translator = ##f
